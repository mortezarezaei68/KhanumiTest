...
namespace UserManagement.Persistance.UnitOfWork
{
    public class IdentityUnitOfWork<TContext, TUser, TRole> : IUnitOfWork
        ...
        where TRole : IdentityRole<int>
    {
        ...
        public IdentityUnitOfWork(TContext context, IEventBus eventBus)
        {
            _context = context;
            _eventBus = eventBus;
        }
